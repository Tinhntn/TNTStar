...
public class CustomerDTO {
    @NotNull(message = "Voucher can't be empty")
    ...
    @Min(value = 0, message = "Invalid point")
    private int point;

    @NotEmpty(message = "Address can't be empty")
    @Size(min=0, max = 255, message = "Address exceed the allowed number of characters")
    ...
    public CustomerDTO(Customer customer){
        this.idVoucher = customer.getVoucher().getId();
